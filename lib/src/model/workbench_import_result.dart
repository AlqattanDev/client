...
part 'workbench_import_result.g.dart';
...
/// * [deployedCalendars] 
/// * [deployedSiteStandards] 
/// * [deployedAIPlugins] 
/// * [errors] 
/// * [warnings] 
@BuiltValue()
abstract class WorkbenchImportResult implements Built<WorkbenchImportResult, WorkbenchImportResultBuilder> {
  ...
  @BuiltValueField(wireName: r'deployedSiteStandards')
  BuiltList<String>? get deployedSiteStandards;

  @BuiltValueField(wireName: r'deployedAIPlugins')
  BuiltList<String>? get deployedAIPlugins;
  ...
  WorkbenchImportResult._();

  factory WorkbenchImportResult([void updates(WorkbenchImportResultBuilder b)]) = _$WorkbenchImportResult;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WorkbenchImportResultBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WorkbenchImportResult> get serializer => _$WorkbenchImportResultSerializer();
}

class _$WorkbenchImportResultSerializer implements PrimitiveSerializer<WorkbenchImportResult> {
  @override
  final Iterable<Type> types = const [WorkbenchImportResult, _$WorkbenchImportResult];

  @override
  final String wireName = r'WorkbenchImportResult';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    WorkbenchImportResult object, {
    ...
    if (object.deployedSiteStandards != null) {
      yield r'deployedSiteStandards';
      yield serializers.serialize(
        object.deployedSiteStandards,
        specifiedType: const FullType(BuiltList, [FullType(String)]),
      );
    }
    if (object.deployedAIPlugins != null) {
      yield r'deployedAIPlugins';
      yield serializers.serialize(
        object.deployedAIPlugins,
        specifiedType: const FullType(BuiltList, [FullType(String)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required WorkbenchImportResultBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'deployedCalendars':
          ...
          break;
        case r'deployedSiteStandards':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(String)]),
          ) as BuiltList<String>;
          result.deployedSiteStandards.replace(valueDes);
          break;
        case r'deployedAIPlugins':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(String)]),
          ) as BuiltList<String>;
          result.deployedAIPlugins.replace(valueDes);
          break;
        case r'errors':
          final valueDes = serializers.deserialize(
            value,
  ...
  @override
  WorkbenchImportResult deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = WorkbenchImportResultBuilder();
