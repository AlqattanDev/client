...
import 'package:openapi/src/model/token_data_response.dart';
...
abstract class TokenList implements Built<TokenList, TokenListBuilder> {
  ...
  BuiltList<TokenDataResponse> get tokens;
...
class _$TokenListSerializer implements PrimitiveSerializer<TokenList> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.tokens,
      specifiedType: const FullType(BuiltList, [FullType(TokenDataResponse)]),
    );
  }
      ...
      switch (key) {
        case r'tokens':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(TokenDataResponse)]),
          ) as BuiltList<TokenDataResponse>;
