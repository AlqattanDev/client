...
abstract class ErrorData implements Built<ErrorData, ErrorDataBuilder> {
  ...
  factory ErrorData([void updates(ErrorDataBuilder b)]) = _$ErrorData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ErrorDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ErrorData> get serializer => _$ErrorDataSerializer();
}

class _$ErrorDataSerializer implements PrimitiveSerializer<ErrorData> {
  @override
  final Iterable<Type> types = const [ErrorData, _$ErrorData];

  @override
  final String wireName = r'ErrorData';
  ...
  void _deserializeProperties(
    ...
    required ErrorDataBuilder result,
  ...
  @override
  ErrorData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ErrorDataBuilder();
