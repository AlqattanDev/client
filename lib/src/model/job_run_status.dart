...
@BuiltValue()
abstract class JobRunStatus implements Built<JobRunStatus, JobRunStatusBuilder> {
  /// Order ID of the job.
  ...
  factory JobRunStatus([void updates(JobRunStatusBuilder b)]) = _$JobRunStatus;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(JobRunStatusBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<JobRunStatus> get serializer => _$JobRunStatusSerializer();
}

class _$JobRunStatusSerializer implements PrimitiveSerializer<JobRunStatus> {
  @override
  final Iterable<Type> types = const [JobRunStatus, _$JobRunStatus];

  @override
  final String wireName = r'JobRunStatus';
  ...
  void _deserializeProperties(
    ...
    required JobRunStatusBuilder result,
  ...
  @override
  JobRunStatus deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = JobRunStatusBuilder();
