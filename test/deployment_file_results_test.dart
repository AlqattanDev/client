...
// tests for DeploymentFileResults
void main() {
  final instance = DeploymentFileResultsBuilder();
  // TODO add properties to the builder and call build()

  group(DeploymentFileResults, () {
    ...
    // BuiltList<String> deployedSiteStandardss
    test('to test the property `deployedSiteStandardss`', () async {
      // TODO
    });
